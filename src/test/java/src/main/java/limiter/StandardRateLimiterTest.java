...
class StandardRateLimiterTest {
  ...
  void standardRateLimiterShouldHandleAverageInTime(int calls, int throughput) {
  ...
  void standardRateLimiterShouldHandleMicroExecutionTimeValues(int calls, int throughput) {
